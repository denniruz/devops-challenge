...
public class WordCountApplicationTests {
	...
	public void cleanUp() throws Exception {
		template.delete(base + "word/beef");
		template.delete(base + "word/beef");
		template.delete(base + "word/beef");
		template.delete(base + "word/chicken");
	}
	...
	@Test
	public void testMultipleWordBody() {
		String endpoint = base.toString() + "word/badword";
		Map<String, String> badBody = createBody("two words");
		ResponseEntity<String> response = template.postForEntity(endpoint, badBody, String.class);
		assertThat(response.getStatusCode(), equalTo(HttpStatus.CONFLICT));
	}

	@Test
	public void testNotFound() {
		ResponseEntity<String> response = template.getForEntity(base.toString() + "words/doesnotexist", String.class);
